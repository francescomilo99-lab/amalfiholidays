...
import { MapPin, ArrowLeft, ChevronLeft, ChevronRight, Maximize2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-32 bg-gray-50 p-8 rounded-3xl border border-gray-100 shadow-sm">
              ...
              <a
                href={`https://wa.me/393384828132?text=${encodeURIComponent(`Salve, vorrei prenotare un tavolo al ristorante: ${restaurant.name}`)}`}
                target="_blank"
              ...
              <a
                href={`mailto:info@amalfiholidays.it?subject=Prenotazione tavolo: ${restaurant.name}`}
