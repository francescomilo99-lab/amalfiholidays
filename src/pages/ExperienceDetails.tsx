        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-32 bg-gray-50 p-8 rounded-3xl border border-gray-100 shadow-sm">
              ...
              <a
                href={`https://wa.me/393331234567?text=${encodeURIComponent(`Salve, vorrei maggiori informazioni sull'esperienza: ${title}`)}`}
                target="_blank"
              ...
              <a
                href={`mailto:info@amalfiholidays.com?subject=Richiesta info esperienza: ${title}`}
