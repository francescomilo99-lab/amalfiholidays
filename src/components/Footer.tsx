      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-3xl font-serif font-bold mb-6 tracking-wider">Amalfi Holidays</h2>
            <p className="text-gray-300 mb-8 max-w-md leading-relaxed">
              {t('about.text')}
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-[#F2A900] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Via Roma 123, Amalfi (SA), Italia</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 mr-3 text-[#F2A900]" />
                <span className="text-gray-300">+39 333 1234567</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-3 text-[#F2A900]" />
                <a href="mailto:info@amalfiholidays.com" className="text-gray-300 hover:text-white transition-colors">info@amalfiholidays.com</a>
              </li>
            </ul>
          </div>
        </div>
